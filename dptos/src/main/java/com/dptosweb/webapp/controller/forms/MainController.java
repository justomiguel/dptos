...
public class MainController {
	...
	MainController() {
		...
		data.add(new Tag(22, "Las Breñas"));
		...
		data.add(new Tag(28, "Roque Saenz Peña"));
		...
		data.add(new Tag(40, "Mayor Villafañe"));
